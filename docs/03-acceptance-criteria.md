...
- **Given** người dùng đăng nhập, **When** xác nhận xóa (gõ lại email), **Then** toàn bộ ChatSession, Source, Chunk/embedding, file S3, Message của user bị xóa; tài khoản không đăng nhập được nữa.
